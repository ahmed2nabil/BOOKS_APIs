exports.queryList = {
    ...
    VALUES($1, $2, $3, $4, $5, $6);`,
    GET_USER_LIST_QUERY: 'SELECT USER_ID, USERNAME, EMAIL, USER_TYPE_CODE, ACTIVE FROM BMS.APP_USER;',
    SAVE_USER_QUERY : `INSERT INTO BMS.APP_USER
    (USERNAME, PASSWORD, EMAIL, USER_TYPE_CODE, ACTIVE, CREATED_ON, CREATED_BY, UPDATED_ON, UPDATED_BY)
    VALUES($1, $2, $3, $4, 1, $5, $6, $7, $8);
    `,
    IS_USER_EXISTS_QUERY : 'SELECT COUNT(USER_ID) FROM BMS.APP_USER WHERE LOWER(USERNAME) = LOWER($1) OR LOWER(EMAIL) = LOWER($2);',
    LOGIN_QUERY : 'SELECT USER_ID, USERNAME, PASSWORD, EMAIL, USER_TYPE_CODE, ACTIVE FROM BMS.APP_USER WHERE LOWER(USERNAME) = LOWER($1) AND ACTIVE = 1;'
}